...
class BiLSTMClassifier:
    ...
    def fit(self, train_data, train_labels, filepath="./BiLSTM-Model.h5", scalerPath="./BiLSTM-Scaler-Model.z", val_data=None, val_labels=None):
        """
        训练模型
    ...
    def predict(self, test_data, filepath="./BiLSTM-Model.h5", scalerPath="./BiLSTM-Scaler-Model.z"):
        """
        预测
